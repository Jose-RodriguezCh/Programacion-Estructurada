'''
Sets.-
Es un tipo de datos para tener una colección de valores pero no tiene 
ni indice ni orden.
...
#Almacenar en una lista y posteriormente mostrar en pantalla los emails sin duplicados
